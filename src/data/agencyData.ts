...
export const AGENCY_SERVICES: ServiceItem[] = [
  {
    id: "digital",
    name: "Digital",
    shortDesc: "Social Media, Content & Paid Campaigns",
    description: "End-to-end digital marketing engineered for measurable audience growth, high engagement, and conversion.",
    tags: ["Social Media Management", "Content Strategy", "Paid Advertising", "Campaign Management", "Meta & Google Ads"],
  ...
  },
  {
    id: "branding",
    name: "Branding",
    shortDesc: "Visual Identity, Guidelines & Systems",
    description: "Crafting distinctive brand identities that stand the test of time and leave a lasting impression in minds.",
    tags: ["Logo Design", "Brand Guidelines", "Visual Identity", "Corporate Rebranding", "Typography & Color Systems"],
  ...
  },
  {
    id: "creative",
    name: "Creative",
    shortDesc: "Art Direction, Motion & Dynamic Content",
    description: "High-impact visual narratives, commercial motion reels, and art-directed campaigns built to stop the scroll.",
    tags: ["Static Design", "Reels & Shorts", "Motion Graphics", "Creative Campaigns", "Video Content"],
  ...
  },
  {
    id: "packaging",
    name: "Packaging",
    shortDesc: "Retail Packaging, Menus & Print Collateral",
    description: "Shelf-ready tactile designs engineered to compete and win in retail, FMCG, and hospitality environments.",
    tags: ["Packaging Design", "Menu Design", "Signage", "Corporate Materials", "Print Production"],
  ...
  },
  {
    id: "strategy",
    name: "Strategy",
    shortDesc: "Go-to-Market, Positioning & Market Consultancy",
    description: "Data-informed strategic roadmaps ensuring creative investments align directly with business revenue.",
    tags: ["Marketing Strategy", "Campaign Planning", "Brand Activation", "Market Research", "Consultancy"],
